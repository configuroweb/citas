		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Nombre de Sistema</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">Nombre Corto de Sistema</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Baner de Página</label>
				<div class="custom-file">
